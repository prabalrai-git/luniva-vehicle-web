...
const VehicleOwner2 = (props) => {
    const { onSuccess, forEdit, onBack, vehicleDetailsNumberPrev, ownerDetailsNumberPrev, ownerDetailsNumber, defaultCompany, appDefSet, appDefDate, forEditEntryDate, token } = props
